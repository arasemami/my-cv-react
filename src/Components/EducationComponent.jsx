                    ...
                    <div className="career">
                        ...
                        <div className="educationDesc">
                            ...
                            <div className="educationDescProject">
                                ...
                                <p> at Zino we firmly believe in the symbiosis between mankind and machine. Technology brings efficiency and lowers costs, while people will always bring trust and empathy to the table. That’s why we’re developing ERP solutions that save time and money, but that incorporates the human factor as well: instead of being imposed on people, our technology serves people.</p>
                                <p> the tech stack use it includes: <br/> Angular, .net Core, Cucumber, Docker, kubernetes, Swagger, TeamCity, Jira, Gitlab, RestFul, TDD, BDD, and DDD, Scss, Typescript, Kendo UI, Neo4j, Mongo, SQL </p>
                                <span className="educationIcon">
                                    <span class="color1">
                                    ...
                                    <span class="color1">
                                        ...
                                        <a href="http://www.zinotech.co">www.zinotech.co</a>
                                    </span>
                        ...
                        <div className="educationDesc">
                            ...
                            <ul className="educationDescProjectUl">
                                ...
                                <p> Using frameworks and technologies such as PHP Laravel, Wordpress, Electron, React, Redux, Babel, Gulp, GreenSock, Node.js and React Native. working with Test Driven Development in React with Jest and Enzyme, I also introduced working with Git Flow and supporting my colleagues to write nice readable and reusable code. </p>
                                <span className="educationIcon">
                                    <span class="color1">
                                        <FontAwesomeIcon icon={['fas', 'map-marker-alt']} />
                                        <a>Turkey , Ankara</a>
